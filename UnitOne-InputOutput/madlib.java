...
public class madlib { 
    public static void main(String[] args){
         ...
         //Outcome
         JOptionPane.showMessageDialog(null, "Congrats, you finished! Here's the madlib:\n\nThere once was a person named " + name0 + "\nWho " + verb0 + " " + adjective0 + " every day with their " + adjective1 + " " + noun0 + ".", "Your MadLib", -1, null);
   }
